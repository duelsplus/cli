...
function showBanner() {
  // this is just generated by figlet, i hope this is changed later caused this is pure cancer
  console.log(`
${brandRed}       ....                        
 ...
 .H8888888888888:                  
 888*"""?""*88888X                 
'f     d8x.   ^%88k${reset}       ${brandDarkRed}888${reset}      
${brandRed}'>    <88888X   '?8${reset}       ${brandDarkRed}888${reset}      
${brandRed} \`:..:\`888888>    8>${reset}      ${brandDarkRed}888${reset}      
${brandRed}        \`"*88     X${reset}  ${brandDarkRed}8888888888888${reset} 
${brandRed}   .xHHhx.."      !${reset}  ${brandDarkRed}8888888888888${reset} 
${brandRed} X88888888hx. ..!${reset}        ${brandDarkRed}888${reset}      
${brandRed} !   "*888888888"${reset}        ${brandDarkRed}888${reset}      
${brandRed}        ^"***"\`${reset}          ${brandDarkRed}888${reset}      

            ${info}v${version}${reset}
`);
}
